...
If you're coming from Italian cooking specifically — which is where the Borderless Kitchen reader base starts — the [free 5-day mini-course](/mini-course) maps each Japanese technique directly to its Italian equivalent, one day at a time.
