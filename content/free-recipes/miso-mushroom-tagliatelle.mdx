...
The complete application of this principle across 37 recipes — including a longer miso mushroom braise and the dashi risotto that uses the same glutamate-stacking logic — is in [Tokyo Meets Tuscany](https://www.amazon.com/dp/B0GY8H2TCQ).
